...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="bg-gray-50 text-black/50">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://via.placeholder.com/877x500" alt="Background Gudang Kosmetik" />
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <!-- Produk Section -->
                            <a
                                href="{{ auth()->check() ? route('produk.index') : route('login') }}"
                                id="products-card"
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://via.placeholder.com/877x500"
                                        alt="Produk Kosmetik"
                                        ...
                                        onerror="
                                            ...
                                            document.getElementById('products-card').classList.add('!row-span-1');
                                            document.getElementById('products-card-content').classList.add('!flex-row');
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="products-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Produk</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Kelola produk Anda dengan mudah. Tambah, edit, dan hapus produk untuk memastikan inventaris selalu terupdate.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <!-- Postingan Section -->
                            <a
                                href="{{ auth()->check() ? route('postingan.index') : route('login') }}"
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Postingan</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Buat dan kelola postingan tentang produk Anda. Bagikan informasi terbaru, tips, dan promosi kepada pelanggan.
                                    </p>
                                </div>
